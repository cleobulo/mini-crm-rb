...
class InteractionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create interaction" do
    assert_difference("Interaction.count") do
      post interactions_url, params: { interaction: { content: @interaction.content, lead_id: @interaction.lead_id } }
    end
  ...
  test "should update interaction" do
    patch interaction_url(@interaction), params: { interaction: { content: @interaction.content, lead_id: @interaction.lead_id } }
